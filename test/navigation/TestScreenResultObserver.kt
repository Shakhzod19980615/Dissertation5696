 ...
 */
package ru.arzonpay.android.ui.test.navigation
...
class TestScreenResultObserver() : ScreenResultObserver {
    ...
    override fun <T : Serializable, R : ResultRoute<T>> addListener(
        targetRoute: R,
    ...
    override fun <R : ResultRoute<*>> removeListener(targetRoute: R) {
        /* do nothing */
    }
}