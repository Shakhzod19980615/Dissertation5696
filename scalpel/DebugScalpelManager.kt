...
object DebugScalpelManager {
    ...
    private lateinit var shakeDetector: ru.arzonpay.android.f_debug.scalpel.DebugShakeDetector
    ...
    private fun initShakeDetector() {
        shakeDetector = ru.arzonpay.android.f_debug.scalpel.DebugShakeDetector {
            shakeDetectedSubject.onNext(System.currentTimeMillis())
        }
        shakeDetector.setSensitivity(ru.arzonpay.android.f_debug.scalpel.DebugShakeDetector.SENSITIVITY_MEDIUM)
    }
